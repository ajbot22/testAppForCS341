...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addButton.setOnClickListener {
            // Add a new item to the GridLayout
            val newItemNumber = gridLayout.childCount / 2 + 1 // Calculate the item number
            val newItemText = "Item $newItemNumber"

            val newItemTextView = TextView(this)
            newItemTextView.text = newItemText
            val newItemButton = Button(this)
            newItemButton.text = "Add"

            // Add the new item and button to the GridLayout
            gridLayout.addView(newItemTextView)
            gridLayout.addView(newItemButton)

            // Set a click listener for the new "Add" button
            newItemButton.setOnClickListener {
                // Handle the click event for the new "Add" button here
            }
        }
